            ...
            if (mysql_query(conn, query.c_str()) == 0) {
                ...
                while ((row = mysql_fetch_row(result))) {
                    ...
                    store.push_back({
                        ...
                        {"delivery_fee", row[9] ? row[9] : ""},
                        {"minimum_order", row[10] ? row[10] : ""},
                        {"store_desc", row[11] ? row[11] : ""},
                        {"menu_info", j},
                        {"origin_info", row[13] ? row[13] : ""},
                        {"nutrition_fact", row[14] ? row[14] : ""},
                        {"allergen_info", row[15] ? row[15] : ""},
                        {"stataus", row[16] ? row[16] : ""}
                    });
                }
